...
#write question
		...
		tempquestions.write("\n")
#write answer
		tempquestions.write("$\\begin{array}{ll} x = " + str(x) + " \\\\ y = " + str(y) + " \\end{array}$")





def simeqlinsub1(n,explanationn):
	import random
	for x in range(0, n):
		tempquestions = open("tempquestions","a")
		tempquestions.write("\n")
#create question
		...
		if random.randrange(1,3)==1:
			...
			a = same
			b = choices1[choice] * signer
			c = a * x + b * y
			d = same
			e = choices2[choice] * signer
			f = d * x + e * y
		if b<0:
			sign1 = " - "
			b = abs(b)
...
def simeqlinsub2(n,explanationn):
	import random
	for x in range(0, n):
		tempquestions = open("tempquestions","a")
		tempquestions.write("\n")
		...
		if num1%co1==0:
			...
			if (m * x1 + cc)%1==0:
				...
				if y1>0:
					...
					y1int = ceil(y1.numerator/y1.denominator)
				y1 = y1 - y1int
				if y1int==0:
					if y1<0:	
						y1 = "-$\\dfrac{" + str(abs(y1.numerator)) + "}{" + str(y1.denominator) + "}$"
					else:
						y1 = "$\\dfrac{" + str(abs(y1.numerator)) + "}{" + str(y1.denominator) + "}$"
				else:
					y1 = str(y1int) + "$\\dfrac{" + str(abs(y1.numerator)) + "}{" + str(y1.denominator) + "}$"
		else:
			...
			if x1>0:
				...
				x1int = ceil(x1.numerator/x1.denominator)
			x1 = x1 - x1int
			if x1int==0:
				if x1<0:	
					x1 = "-$\\dfrac{" + str(abs(x1.numerator)) + "}{" + str(x1.denominator) + "}$"
				else:
					x1 = "$\\dfrac{" + str(abs(x1.numerator)) + "}{" + str(x1.denominator) + "}$"
			else:
				x1 = str(x1int) + "$\\dfrac{" + str(abs(x1.numerator)) + "}{" + str(x1.denominator) + "}$"
		if num2%co2==0:
			x2 = int((num2 * -1)/co2)
			if (m * x2 + cc)%1==0:
				y2 = m * x2 + cc
				...
				if y2>0:
					...
					y2int = ceil(y2.numerator/y2.denominator)
				y2 = y2 - y2int
				if y2int==0:
					if y2<0:	
						y2 = "-$\\dfrac{" + str(abs(y2.numerator)) + "}{" + str(y2.denominator) + "}$"
					else:
						y2 = "$\\dfrac{" + str(abs(y2.numerator)) + "}{" + str(y2.denominator) + "}$"
				else:
					y2 = str(y2int) + "$\\dfrac{" + str(abs(y2.numerator)) + "}{" + str(y2.denominator) + "}$"
		else:
			...
			if x2>0:
				...
				x2int = ceil(x2.numerator/x2.denominator)
			x2 = x2 - x2int
			if x2int==0:
				if x2<0:	
					x2 = "-$\\dfrac{" + str(abs(x2.numerator)) + "}{" + str(x2.denominator) + "}$"
				else:
					x2 = "$\\dfrac{" + str(abs(x2.numerator)) + "}{" + str(x2.denominator) + "}$"
			else:
				x2 = str(x2int) + "$\\dfrac{" + str(abs(x2.numerator)) + "}{" + str(x2.denominator) + "}$"
		if b<0:
			sign1 = " - "
			b = abs(b)
		else:
...
def simeqlinpos1(n,explanationn):
	import random
	for x in range(0, n):
		tempquestions = open("tempquestions","a")
		tempquestions.write("\n")
#create question
		...
		if random.randrange(1,3)==1:
			...
			e = choices2[choice]
			f = d * x + e * y
		question = "$\\begin{array}{ll} " + str(a) + "x + " + str(b) + "y = " + str(c) + "\\\\" + str(d) + "x + " + str(e) + "y = " + str(f) + " \\end{array}$"
		answer = "$\\begin{array}{ll} x = " + str(x) + " \\\\ y = " + str(y) + " \\end{array}$"
#write question
...
def simeqlinpos2(n,explanationn):
	import random
	for x in range(0, n):
		tempquestions = open("tempquestions","a")
		tempquestions.write("\n")
...
def simeqlinpos3(n,explanationn):
	import random
	for x in range(0, n):
		tempquestions = open("tempquestions","a")
		tempquestions.write("\n")
...
def simeqlinadd1(n,explanationn):
	import random
	for x in range(0, n):
		tempquestions = open("tempquestions","a")
		tempquestions.write("\n")
...
def simeqlinadd2(n,explanationn):
	import random
	for x in range(0, n):
		tempquestions = open("tempquestions","a")
		tempquestions.write("\n")
