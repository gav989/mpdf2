...
filename = "Circles Table In Terms Of Pi Area Full"
topic = "Circles"
title = "Table Area In Terms Of Pi Full"
hint = "~"
from shape.circles import circletablepiareafull
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablepiareafull(8,0)
tempquestions.close()
