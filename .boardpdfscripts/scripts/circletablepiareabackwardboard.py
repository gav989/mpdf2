...
filename = "Circles Table In Terms Of Pi Area Backward"
topic = "Circles"
title = "Table in Terms Of Pi Area Backward"
hint = "~"
from shape.circles import circletablepiareabackward
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablepiareabackward(8,0)
tempquestions.close()
