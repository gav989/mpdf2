...
filename = "Negative Multiplication and Division Torture"
title = "Multiplying and Dividing Negative Numbers"
from torture.torture import negativemultiply1, negativemultiply2, negativedivide1, negativedivide2, negativedivide3
tempquestions = open("tempquestions","a")
for x in range(0,1):
	negativemultiply1(25)
	negativemultiply2(25)
	negativedivide1(25)
	negativedivide2(25)
	negativedivide3(25)
tempquestions.close()
