...
#TODO
#proper change question

from examquestions.number import changefromtransaction3
...
for x in range(0,6):
	question1 = [changefromtransaction3]
	question2 = [decimaladdition]
	question3 = [twobythreemultiplication]
	question4 = [singledigitdivision,twodigitdivisioneasy]
	question5 = [multten,multhundred,multthousand]
	question6 = [divten,divhundred,divthousand]
