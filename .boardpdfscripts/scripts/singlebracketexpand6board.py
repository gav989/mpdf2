...
filename = "Single Bracket Expansion 6"
topic = "Algebra"
title = "Single Bracket Expansion 6"
hint = "Expand:"
from algebra.manipulation import singlebracketexpansion6
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketexpansion6(16,0)
tempquestions.close()
