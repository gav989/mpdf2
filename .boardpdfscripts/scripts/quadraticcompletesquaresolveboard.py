#!/usr/bin/env python3
filename = "Quadratic Completing The Square To Solve"
topic = "Quadratics"
title = "Completing The Square To Solve"
hint = "Solve by completing the square and state the minimum point of:"
from equations.quadratics import completesquaresolve
tempquestions = open("tempquestions","a")
for x in range(0,3):
	completesquaresolve(16,0)
