...
filename = "Multiplication 3"
topic = "Written Calculation"
title = "Multiplication 3"
hint = "Calculate:"
from fouroperators.multiplication import timestables,twobyonemultiplication,twobytwomultiplication,twobythreemultiplication,decimalmultiplication1,decimalmultiplication2
tempquestions = open("tempquestions","a")
for x in range(0,3):
	twobythreemultiplication(16,0)
tempquestions.close()
