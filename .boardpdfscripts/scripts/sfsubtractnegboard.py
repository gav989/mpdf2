...
filename = "Standard Form Subtraction Negative Index"
topic = "Indices and Standard Form"
title = "Standard Form Subtraction"
hint = "Calculate, leaving your answers as ordinary numbers: "
from indices.standardform import sfsubtractneg
for x in range(0,3):
