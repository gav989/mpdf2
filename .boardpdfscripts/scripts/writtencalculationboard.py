...
topic = "Written Calculation"
title = "Mixed Questions"
hint = "Calculate:"
from fouroperators.multiplication import twobyonemultiplication,twobytwomultiplication,twobythreemultiplication
from fouroperators.addition import fulladdition
from fouroperators.subtraction import fullsubtraction
from fouroperators.division import singledigitdivision,twodigitdivision
...
for x in range(0,48):
	...
	if d==1:
		...
		d2 = random.randrange(0,3)
		if d2==0:
			twobyonemultiplication(1,0)
		elif d2==1:
			twobytwomultiplication(1,0)
		else:
			twobythreemultiplication(1,0)
	else:
		d2 = random.randrange(0,2)
		if d2==0:
			singledigitdivision(1,0)
		else:
			twodigitdivision(1,0)
tempquestions.close()
...
shutil.copyfile("templates/board.tex", "temp1")
decision = 1
