...
filename = "Decimal Multiplication Mix"
topic = "Written Calculation"
title = "Decimal Multiplication Mix"
hint = "Calculate:"
from fouroperators.multiplication import decimalmultiplication1,decimalmultiplication2
tempquestions = open("tempquestions","a")
for x in range(0,48):
	if random.randrange(0,2)==1:
		decimalmultiplication1(1,0)
	else:
		decimalmultiplication2(1,0)
tempquestions.close()
