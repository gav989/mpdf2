...
filename = "Circles Table Circumference Backward"
topic = "Circles"
title = "Table Circumference Backward"
hint = "~"
from shape.circles import circletablecircumferencebackward
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablecircumferencebackward(8,0)
tempquestions.close()
