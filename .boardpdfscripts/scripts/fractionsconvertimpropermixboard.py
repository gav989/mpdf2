...
filename = "Fractions Improper Conversions Mix"
topic = "Fractions"
title = "Converting between Improper Fractions and Mixed Numbers"
hint = "Convert to mixed numbers: \hfill Convert to improper fractions:~~~~~~~~~"
from fdp.fractionoperations import fractionconvert2,fractionconvert1
tempquestions = open("tempquestions","a")
for x in range(0,3):
	fractionconvert1(8,0)
	fractionconvert2(8,0)
tempquestions.close()
