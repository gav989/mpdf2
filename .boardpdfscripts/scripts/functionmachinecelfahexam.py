...
filename = "Function Machine Celsius Fahrenheit EQ"
topic = "Function Machines"
title = "Temperature Exam Question"
hint = "~"
from examquestions.algebra import celfahfunctionmachine
tempquestions = open("tempquestions","a")
for x in range(0,6):
	celfahfunctionmachine(8,0)
tempquestions.close()
