...
filename = "Single Bracket Factorisation 8"
topic = "Algebra"
title = "Single Bracket Factorisation 8"
hint = "Factorise fully:"
from algebra.manipulation import singlebracketfactorise8
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketfactorise8(16,0)
tempquestions.close()
