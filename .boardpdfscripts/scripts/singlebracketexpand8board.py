...
filename = "Single Bracket Expansion 8"
topic = "Algebra"
title = "Single Bracket Expansion 8"
hint = "Expand:"
from algebra.manipulation import singlebracketexpansion8
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketexpansion8(16,0)
tempquestions.close()
