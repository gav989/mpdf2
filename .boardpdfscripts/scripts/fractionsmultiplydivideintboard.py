...
filename = "Fractions Multiplication and Division by Integers"
topic = "Fractions"
title = "Multiplication and Division by Integers"
hint = "Find:"
from fdp.fractionoperations import fractionsmultiplyinteger,fractionsdivideinteger
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question = [fractionsmultiplyinteger,fractionsdivideinteger]
	question[random.randrange(0,2)](1,0)
tempquestions.close()
...
shutil.copyfile("templates/boardtall.tex", "temp1")
decision = 1
