...
filename = "Fractions Improper Conversions 1"
topic = "Fractions"
title = "Converting to Mixed Numbers"
hint = "Convert the following fractions to mixed numbers: "
from fdp.fractionoperations import fractionconvert1
tempquestions = open("tempquestions","a")
for x in range(0,3):
	fractionconvert1(16,0)
tempquestions.close()
