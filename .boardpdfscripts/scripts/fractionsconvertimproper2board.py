...
filename = "Fractions Improper Conversions 2"
topic = "Fractions"
title = "Converting to Improper Fractions"
hint = "Convert the following mixed numbers to improper fractions: "
from fdp.fractionoperations import fractionconvert2
tempquestions = open("tempquestions","a")
for x in range(0,3):
	fractionconvert2(16,0)
tempquestions.close()
