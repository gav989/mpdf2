...
filename = "Venn Diagrams Mix"
topic = "Venn Diagrams"
title = "Mix"
hint = "~"
from data.venn import vennneither,vennboth
tempquestions = open("tempquestions","a")
for x in range(0,12):
	questions = [vennneither,vennneither,vennboth,vennboth]
...
shutil.copyfile("templates/boardfour2.tex", "temp1")
decision = 1
