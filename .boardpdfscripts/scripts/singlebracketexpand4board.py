...
filename = "Single Bracket Expansion 4"
topic = "Algebra"
title = "Single Bracket Expansion 4"
hint = "Expand:"
from algebra.manipulation import singlebracketexpansion4
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketexpansion4(16,0)
tempquestions.close()
