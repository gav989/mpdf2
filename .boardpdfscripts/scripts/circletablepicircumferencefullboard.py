...
filename = "Circles Table In Terms Of Pi Circumference Full"
topic = "Circles"
title = "Table In Terms Of Pi Circumference Full"
hint = "~"
from shape.circles import circletablepicircumferencefull
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablepicircumferencefull(8,0)
tempquestions.close()
