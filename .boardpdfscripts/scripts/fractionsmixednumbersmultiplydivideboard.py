...
filename = "Fractions Multiplication and Division Mixed Numbers Mix"
topic = "Fractions"
title = "Multiplication and Division of Mixed Numbers"
hint = "Find:"
from fdp.fractionoperations import mixednumbersmultiply,mixednumbersdivide
tempquestions = open("tempquestions","a")
for x in range(0,48):
	dec = random.randrange(1,3)
	if dec==1:
		mixednumbersmultiply(1,0)
	else:
		mixednumbersdivide(1,0)
tempquestions.close()
