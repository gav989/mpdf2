...
filename = "Circles Table In Terms Of Pi Circumference Backward"
topic = "Circles"
title = "Table In Terms Of Pi Circumference Backward"
hint = "~"
from shape.circles import circletablepicircumferencebackward
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablepicircumferencebackward(8,0)
tempquestions.close()
...
shutil.copyfile("templates/boardone2.tex", "temp1")
decision = 1
...
readdoc.close()
writedoc.close()
shutil.copyfile("temp1","deleteme.tex")


subprocess.run(["pdflatex","--shell-escape","deleteme.tex"])
os.rename("deleteme.pdf",filename+".pdf")
