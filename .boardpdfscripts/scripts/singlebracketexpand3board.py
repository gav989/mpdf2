...
filename = "Single Bracket Expansion 3"
topic = "Algebra"
title = "Single Bracket Expansion 3"
hint = "Expand:"
from algebra.manipulation import singlebracketexpansion3
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketexpansion3(16,0)
tempquestions.close()
