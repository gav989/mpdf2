...
filename = "Proportion Inverse Square Root"
topic = "Proportion"
title = "Inverse Square Root"
hint = "y is inversely proportional to the square root of x."
from algebra.proportion import inversesquareroot
tempquestions = open("tempquestions","a")
for x in range(0,6):
	inversesquareroot(8,0)
tempquestions.close()
