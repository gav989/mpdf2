...
filename = "Single Bracket Factorisation 1 & 3"
topic = "Algebra"
title = "Single Bracket Factorisation Mix"
hint = "Factorise fully:"
from algebra.manipulation import singlebracketfactorise1,singlebracketfactorise3
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question1 = [singlebracketfactorise1,singlebracketfactorise3]
	random.choice(question1)(1,0)
tempquestions.close()
