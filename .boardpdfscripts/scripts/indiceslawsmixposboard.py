...
filename = "Indices Laws Mix Positive"
topic = "Indices"
title = "Laws Of Indices Positive"
hint = "Simplify the following, writing your answers in index form:"
from indices.laws import divindpos,multindpos,indindpos
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question = [divindpos,multindpos,indindpos]
	random.choice(question)(1,0)
tempquestions.close()
