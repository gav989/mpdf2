...
filename = "Fractions Equivalence"
topic = "Fractions"
title = "Finding Equivalent Fractions"
hint = "Find the missing numerator or denominator"
from fdp.fractionoperations import fractionsequivalent
tempquestions = open("tempquestions","a")
for x in range(0,3):
	fractionsequivalent(16,0)
tempquestions.close()
