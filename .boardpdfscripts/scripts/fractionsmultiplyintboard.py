...
filename = "Fractions Multiplication by Integers"
topic = "Fractions"
title = "Multiplication by Integers"
hint = "Find:"
from fdp.fractionoperations import fractionsmultiplyinteger
tempquestions = open("tempquestions","a")
for x in range(0,3):
	fractionsmultiplyinteger(16,0)
tempquestions.close()
