...
filename = "Single Bracket Factorisation 1"
topic = "Algebra"
title = "Single Bracket Factorisation 1"
hint = "Factorise fully:"
from algebra.manipulation import singlebracketfactorise1
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketfactorise1(16,0)
tempquestions.close()
