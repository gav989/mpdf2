...
filename = "Shapes Names Mix"
topic = "Shape Names"
title = "Mix"
hint = "~"
from shape.names import triangles,quadrilaterals,polygons,threed
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question = [triangles,quadrilaterals,polygons,threed]
...
shutil.copyfile("templates/boardone.tex", "temp1")
decision = 1
