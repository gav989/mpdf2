...
filename = "10 100 1000 Multiplication Division"
topic = "Written Calculation"
title = "Multipliying and Dividing by 10, 100 and 1000"
hint = "Calculate:"
from fouroperators.ten import multten,multhundred,multthousand,divten,divhundred,divthousand
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question = [multten,multhundred,multthousand,divten,divhundred,divthousand]
