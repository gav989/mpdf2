...
filename = "Proportion Direct Square Root"
topic = "Proportion"
title = "Direct Square Root"
hint = "y is directly proportional to the square root of x."
from algebra.proportion import directsquareroot
tempquestions = open("tempquestions","a")
for x in range(0,6):
	directsquareroot(8,0)
tempquestions.close()
