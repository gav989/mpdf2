...
filename = "Single Bracket Factorisation 4"
topic = "Algebra"
title = "Single Bracket Factorisation 4"
hint = "Factorise fully:"
from algebra.manipulation import singlebracketfactorise4
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketfactorise4(16,0)
tempquestions.close()
