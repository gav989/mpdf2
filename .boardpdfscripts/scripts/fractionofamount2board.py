...
filename = "Fraction Of An Amount 2"
topic = "Fractions"
title = "Fraction Of An Amount 2"
hint = "Find:"
from fdp.fractionoperations import fractionofamount1,fractionofamount2,fractionofamount3
tempquestions = open("tempquestions","a")
for x in range(0,3):
	fractionofamount2(16,0)
tempquestions.close()
