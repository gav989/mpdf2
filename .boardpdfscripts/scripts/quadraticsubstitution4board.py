...
filename = "Quadratic Substitution 4"
topic = "Quadratic Graphs"
title = "Substitution 4"
hint = "~"
from graphs.quadratic import substitution4pos,substitution4neg
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question = [substitution4pos,substitution4neg]
	random.choice(question)(1,1)
tempquestions.close()
