...
filename = "Single Bracket Expansion 7"
topic = "Algebra"
title = "Single Bracket Expansion 7"
hint = "Expand:"
from algebra.manipulation import singlebracketexpansion7
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketexpansion7(16,0)
tempquestions.close()
