...
filename = "Times Tables of Two Digit Numbers"
topic = "Written Calculation"
title = "Times Tables of Two Digit Numbers"
hint = "Write out the first five numbers in these times tables:"
from fouroperators.division import twodigittables
