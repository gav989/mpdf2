...
filename = "Decimal Multiplication 2"
topic = "Written Calculation"
title = "Decimal Multiplication 2"
hint = "Calculate:"
from fouroperators.multiplication import decimalmultiplication2
tempquestions = open("tempquestions","a")
for x in range(0,3):
	decimalmultiplication2(16,0)
tempquestions.close()
