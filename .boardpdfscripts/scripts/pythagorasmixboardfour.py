...
filename = "Pythagoras Mix Four"
topic = "Pythagoras"
title = "Finding Any Side"
hint = "~"
from shape.pythagoras import pythagoras1,pythagoras2
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question = [pythagoras1,pythagoras2]
...
shutil.copyfile("templates/boardfour.tex", "temp1")
decision = 1
