...
filename = "Words From Figures 1"
topic = "Written Calculation"
title = "Writing Numbers in Words 1"
hint = "Write the following numbers using words:"
from fouroperators.figwords import figwordsthousands
tempquestions = open("tempquestions","a")
for x in range(0,6):
	figwordsthousands(8,0)
tempquestions.close()
