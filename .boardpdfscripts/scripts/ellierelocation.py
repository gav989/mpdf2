...
filename = "10T8 Cover Worksheet"
topic = "~"
title = "10T8 Cover Work"
hint = "~"
from fouroperators.multiplication import timestables
from equations.linear import onestepadd,onestepsubtract,onestepmultiply,onestepdivide,twostep1,threestep1
from algebra.manipulation import collect1,singlebracketexpansion1,singlebracketexpansion3,singlebracketfactorise1,singlebracketfactorise3
...
for i in range(0,1):
	...
	threestep1(5,1,1)
	collect1(10,1)
	singlebracketexpansion1(5,1)
	singlebracketexpansion1(5,1)
	singlebracketfactorise1(5,1)
	singlebracketfactorise1(5,1)
