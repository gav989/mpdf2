...
filename = "Single Bracket Expansion 5"
topic = "Algebra"
title = "Single Bracket Expansion 5"
hint = "Expand:"
from algebra.manipulation import singlebracketexpansion5
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketexpansion5(16,0)
tempquestions.close()
