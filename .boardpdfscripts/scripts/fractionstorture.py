...
filename = "Fractions Torture"
title = "Fractions"
from fdp.fractionoperations import fractionsadd,fractionssubtract,fractionsmultiply,fractionsdivide
tempquestions = open("tempquestions","a")
for x in range(0,1):
	fractionsadd(17,0)
	fractionssubtract(17,0)
	fractionsmultiply(17,0)
	fractionsdivide(17,0)
questions = [fractionsadd,fractionssubtract,fractionsmultiply,fractionsdivide]
for x in range(0,68):
	random.choice(questions)(1,0)
tempquestions.close()
...
shutil.copyfile("templates/torturetall.tex", "temp1")
decision = 1
