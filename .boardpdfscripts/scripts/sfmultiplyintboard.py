...
filename = "Standard Form Multiplication Integer"
topic = "Indices and Standard Form"
title = "Standard Form Multiplication Integer"
hint = "Calculate, leaving your answers in standard form: "
from indices.standardform import sfmultiplyint
for x in range(0,3):
