...
filename = "Rearranging Formulae 2"
topic = "Algebra"
title = "Rearranging Formulae 2"
hint = "Make x the subject of the following formulae:"
from algebra.manipulation import rearrange2
