...
filename = "KS3 Unit 6 Extension Starter"
topic = "Starter"
title = "Unit 6 Extension"
hint = ""

#TODO
#proper change from transaction
...
from fdp.fractionoperations import fractionsadd,fractionssubtract,fractionsmultiply,fractionsdivide
from algebra.manipulation import collect1,collect2
from fdp.percentages import percofamount5
from equations.linear import twostep1,threestep1

tempquestions = open("tempquestions","a")
for x in range(0,6):

	question1 = [changefromtransaction2,twobythreemultiplication,twodigitdivisioneasy]
	question2 = [fractionsadd,fractionssubtract,fractionsmultiply,fractionsdivide]
	question3 = [collect1,collect2]
	question4 = [orderfdp]
	question5 = [percofamount5]
	question6 = [twostep1,threestep1]
