...
filename = "Single Bracket Expansion 1"
topic = "Algebra"
title = "Single Bracket Expansion 1"
hint = "Expand:"
from algebra.manipulation import singlebracketexpansion1
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketexpansion1(16,0)
tempquestions.close()
