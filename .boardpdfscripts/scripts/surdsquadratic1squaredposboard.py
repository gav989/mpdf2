...
filename = "Surds Quadratic 1 Squared Positive"
topic = "Surds"
title = "Expanding Quadratics 1 Squared Positive"
hint = "Expand and Simplify:"
from indices.surds import surdquadratic1squaredpos
tempquestions = open("tempquestions","a")
for x in range(0,3):
	surdquadratic1squaredpos(16,0)
tempquestions.close()
