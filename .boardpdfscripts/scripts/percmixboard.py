...
filename = "Percentage Mix"
topic = "Fractions, Decimals and Percentages"
title = "Percentages Mix"
hint = "Question 1 is non-calculator"
from fdp.percentages import compoundinterest,percofamount,percofamount5,percincdec,percincdec5,percreverse5,percreverse,percchange5,percchange
import random
for x in range(0,6):
...
shutil.copyfile("templates/boardwide.tex", "temp1")
decision = 1
