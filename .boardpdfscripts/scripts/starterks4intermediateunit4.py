...
filename = "KS4 Intermediate Unit 4 Starter"
topic = "Starter"
title = "Unit 4"
hint = ""

#TODO
#another sweep, this was lazy
...
for x in range(0,6):
	...
	question1 = [percdec,percinc5,reciprocal]
	question2 = [expandquadratics1]
	question3 = [sacuboid]
	question4 = [genseq,nthterm]
	question5 = [squareroot2]
	question6 = [threestep3]
