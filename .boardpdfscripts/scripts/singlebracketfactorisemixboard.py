...
filename = "Single Bracket Factorisation Mix"
topic = "Algebra"
...
for x in range(0,48):
	question1 = [singlebracketfactorise1,singlebracketfactorise2,singlebracketfactorise3,singlebracketfactorise4,singlebracketfactorise5]
