...
filename = "Quadratic Expansion D.O.T.S. 1"
topic = "Quadratics"
title = "Expansion - Difference of two squares"
hint = "Expand and simplify:"
from equations.quadratics import expandquadraticsdots1
tempquestions = open("tempquestions","a")
for x in range(0,3):
	expandquadraticsdots1(16,0)
tempquestions.close()
