...
filename = "Negative Addition and Subtraction Torture"
title = "Adding and Subtracting Negative Numbers"
from torture.torture import negativeadd1, negativeadd2, negativesubtract1, negativesubtract2, negativesubtract3
tempquestions = open("tempquestions","a")
for x in range(0,1):
	negativeadd1(25)
	negativeadd2(25)
	negativesubtract1(25)
	negativesubtract2(25)
	negativesubtract3(25)
tempquestions.close()
