...
filename = "Circles Table Circumference Full"
topic = "Circles"
title = "Table Circumference Full"
hint = "~"
from shape.circles import circletablecircumferencefull
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablecircumferencefull(8,0)
tempquestions.close()
