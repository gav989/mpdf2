...
filename = "Collecting Like Terms Positive Mix"
topic = "Algebra"
title = "Collecting Like Terms Positive Mix"
hint = "Simplify:"
from algebra.manipulation import collect2pos,collect1pos
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question = [collect2pos,collect1pos]
