...
filename = "Single Bracket Factorisation 3"
topic = "Algebra"
title = "Single Bracket Factorisation 3"
hint = "Factorise fully:"
from algebra.manipulation import singlebracketfactorise3
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketfactorise3(16,0)
tempquestions.close()
