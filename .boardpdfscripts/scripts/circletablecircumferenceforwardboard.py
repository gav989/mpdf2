...
filename = "Circles Table Circumference Forward"
topic = "Circles"
title = "Table Circumference Forward"
hint = "~"
from shape.circles import circletablecircumferenceforward
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablecircumferenceforward(8,0)
tempquestions.close()
