...
filename = "Recurring Decimals Mix"
topic = "Recurring Decimals"
title = "Mix"
hint = "Convert the following recurring decimals to fractions in their simplest form:"
from fdp.fdp import recurringdec1,recurringdec2,recurringdec3
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question = [recurringdec1,recurringdec2,recurringdec3]
