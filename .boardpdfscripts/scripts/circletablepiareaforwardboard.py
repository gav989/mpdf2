...
filename = "Circles Table In Terms Of Pi Area Forward"
topic = "Circles"
title = "Table In Terms Of Pi Area Forward"
hint = "~"
from shape.circles import circletablepiareaforward
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablepiareaforward(8,0)
tempquestions.close()
