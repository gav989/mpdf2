...
filename = "Single Bracket Expansion 1 & 3"
topic = "Algebra"
title = "Single Bracket Expansion Mix"
hint = "Expand:"
from algebra.manipulation import singlebracketexpansion1,singlebracketexpansion3
tempquestions = open("tempquestions","a")
for x in range(0,48):
	question1 = [singlebracketexpansion1,singlebracketexpansion3]
