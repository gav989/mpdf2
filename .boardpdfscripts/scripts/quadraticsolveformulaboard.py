#!/usr/bin/env python3
filename = "Quadratic Formula"
topic = "Quadratics"
title = "Solving with the Formula"
hint = "Solve the following equations using the formula $x = \dfrac{-b \pm \sqrt{b^2 - 4ac}}{2a}$:"
from equations.quadratics import quadraticformula
tempquestions = open("tempquestions","a")
for x in range(0,3):
	quadraticformula(16,0)
