...
filename = "Simultaneous Equations Linear Mix"
topic = "Simultaneous Equations"
title = "Linear Mix"
hint = "Solve the following pairs of simultaneous equations:"
from equations.simultaneous import simeqlin1,simeqlin2,simeqlin3
tempquestions = open("tempquestions","a")
for x in range(0,36):
	question = [simeqlin1,simeqlin2,simeqlin3]
...
shutil.copyfile("templates/boardsimeq.tex", "temp1")
decision = 1
