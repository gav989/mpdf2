...
for x in range(0,6):
	if random.randrange(0,2)==1:
		...
		decimaldivision1(1,1)
	hcflcm(1,1)
	orderdecimals(1,1)
	fractionofamount2(1,1)
	fractionsimplify(1,1)
	if random.randrange(0,2)==1:
		fractionconvert1(1,1)
	else:
		fractionconvert2(1,1)
	if random.randrange(0,2)==1:
		fractionsadd(1,1)
	else:
		fractionssubtract(1,1)
	if random.randrange(0,2)==1:
		mixednumbersadd(1,1)
	else:
		mixednumberssubtract(1,1)
tempquestions.close()
