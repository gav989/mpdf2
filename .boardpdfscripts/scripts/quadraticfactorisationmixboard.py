#!/usr/bin/env python3
filename = "Quadratic Factorisation Mix"
topic = "Quadratics"
title = "Factorisation"
hint = "Factorise the following expressions:"
from equations.quadratics import factorisequadratics1,factorisequadratics2
tempquestions = open("tempquestions","a")
for x in range(0,3):
	factorisequadratics1(8,0)
	factorisequadratics2(8,0)
