...
filename = "Circles Table In Terms Of Pi Circumference Forward"
topic = "Circles"
title = "Table In Terms Of Pi Circumference Forward"
hint = "~"
from shape.circles import circletablepicircumferenceforward
tempquestions = open("tempquestions","a")
for x in range(0,6):
	circletablepicircumferenceforward(8,0)
tempquestions.close()
