...
filename = "Words To Figures 1"
topic = "Written Calculation"
title = "Writing Numbers in Figures 1"
hint = "Write the following numbers using figures:"
from fouroperators.figwords import wordfigsthousands
tempquestions = open("tempquestions","a")
for x in range(0,6):
	wordfigsthousands(8,0)
tempquestions.close()
