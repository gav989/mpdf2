...
from fdp.fractionoperations import fractionofamount2,fractionconvert1,fractionconvert2,fractionofamount2,fractionsadd,fractionssubtract,fractionsmultiply,fractionsdivide
from fdp.percentages import percincdec5
from fdp.rounding import round1dp,round2dp,round1sf1
from indices.laws import indindpos,divindpos,multindpos
from primes.primefactors import factortrees1,factortrees2,hcf,lcm

tempquestions = open("tempquestions","a")
for x in range(0,6):

	question1 = [orderfdp,percincdec5,fractionofamount2,fractionconvert1,fractionconvert2,fractionofamount2]
	question2 = [fractionsadd,fractionssubtract,fractionsmultiply,fractionsdivide]
	question3 = [factortrees1,factortrees2,hcf,lcm]
	question4 = [indindpos,divindpos,multindpos]
