...
filename = "Single Bracket Factorisation 5"
topic = "Algebra"
title = "Single Bracket Factorisation 5"
hint = "Factorise fully:"
from algebra.manipulation import singlebracketfactorise5
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketfactorise5(16,0)
tempquestions.close()
