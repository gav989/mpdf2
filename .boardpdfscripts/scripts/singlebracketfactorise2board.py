...
filename = "Single Bracket Factorisation 2"
topic = "Algebra"
title = "Single Bracket Factorisation 2"
hint = "Factorise fully:"
from algebra.manipulation import singlebracketfactorise2
tempquestions = open("tempquestions","a")
for x in range(0,3):
	singlebracketfactorise2(16,0)
tempquestions.close()
